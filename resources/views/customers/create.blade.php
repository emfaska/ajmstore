    ...
    <div class="max-w-4xl mx-auto space-y-6">
        <div class="flex items-center gap-4">
            ...
            <div>
                ...
                <p class="text-sm text-gray-500">Tambahkan data pelanggan untuk riwayat penjualan dan servis.</p>
            </div>
        </div>
        ...
        <form action="{{ route('customers.store') }}" method="POST"
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div class="md:col-span-2">
                    ...
                    <textarea name="address" rows="3"
                        class="w-full rounded-lg border-gray-300 focus:border-blue-500 focus:ring-blue-500 @error('address') border-red-500 @enderror">{{ old('address') }}</textarea>
                    @error('address')
                        <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                    @enderror
                </div>
            ...
            <div class="mt-8 flex justify-end gap-3 border-t border-gray-100 pt-5">
                ...
                <button type="submit"
                    class="px-5 py-2.5 text-sm font-medium text-white bg-blue-600 hover:bg-blue-700 rounded-lg shadow transition-colors">Simpan
                    Pelanggan</button>
            </div>
        </form>
    </div>
